...
runButton.addEventListener("click", async () => {
	import("https://webr.r-wasm.org/latest/webr.mjs").then(async ({ WebR }) => {
      ...
      `);
		...
		async function fetchToWebR(code, path) {
		...
		// 	try {
		// 		await webR.FS.unlink("/home/web_user/app/ui.R");
		...
		await webR.FS.unlink("/home/web_user/app/ui.R");
		await webR.FS.unlink("/home/web_user/app/server.R");
		await webR.FS.mkdir("/home/web_user/app");
		await webR.FS.mkdir("/home/web_user/app/www");
		await fetchToWebR(
			uiCode.value,
			//"app/ui.R",
			"/home/web_user/app/ui.R"
		);
		await fetchToWebR(
			serverCode.value,
			//  "app/server.R",
			"/home/web_user/app/server.R"
		);
